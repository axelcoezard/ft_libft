...
t_vector2	*ft_vector2_init(int x, int y, int z);
...
t_vector3	*ft_vector2_init(int x, int y, int z);
t_vector3	*ft_vector2_add(t_vector3 *a, t_vector3 *b);
t_vector3	*ft_vector2_sub(t_vector3 *a, t_vector3 *b);
t_vector3	*ft_vector2_mul(t_vector3 *a, int x);
t_vector3	*ft_vector2_div(t_vector3 *a, int x);
